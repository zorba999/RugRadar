            ...
            <div className="px-6 py-5 space-y-4" style={{ background: '#0a1220', borderTop: '1px solid #1e2d47' }}>
              ...
              {txHash && (
                <div className="rounded-xl p-4" style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.3)' }}>
                  <p className="text-xs text-slate-600 uppercase tracking-widest mb-2">⛓ Transaction Hash — Base Sepolia</p>
                  <p className="text-xs font-mono text-indigo-300 bg-black/30 px-3 py-2 rounded-lg break-all mb-2">{txHash}</p>
